...
export function NavBar({ variant = "default" }: { variant?: NavVariant }) {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 w-full z-[120] border-b border-[var(--color-gold)]/10 bg-[color-mix(in_srgb,var(--bg-base)_85%,black)] backdrop-blur-xl"
    >
      {/* ✦ Field Glow */}
          ...
          <div className="md:hidden flex justify-end">
            ...
            >
              <div className="w-6 h-5 relative flex flex-col justify-between">
                <motion.span animate={{ rotate: isOpen ? 45 : 0, y: isOpen ? 9 : 0 }} className="w-full h-[1.5px] bg-current" />
...
/* ✦ NavLink — no underline, presence via tone only */
