    ...
    >
      ...
      >
        ...
        <p className="max-w-2xl text-lg md:text-xl text-[var(--text-base)]/80 leading-relaxed">
          Whether you are ready to build the <span className="font-semibold text-[var(--color-gold)]">Vessel</span>, 
          map the <span className="font-semibold text-[var(--color-gold)]">Path</span>, or 
          heal the <span className="font-semibold text-[var(--color-gold)]">Soul</span>—I am here to listen.
        </p>
      </motion.section>
      ...
      >
        <div className="max-w-5xl mx-auto grid gap-12 md:grid-cols-[1.5fr,1fr] items-start">
          ...
          >
             {/* Subtle top glow */}
             <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[var(--color-gold)]/30 to-transparent opacity-50"></div>
            ...
            >
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div>
                  <label htmlFor="name" className="block text-[11px] font-semibold tracking-[0.18em] uppercase text-[var(--text-base)]/70 mb-2">
                    Name
                  </label>
                  <input
                    id="name"
                ...
                <div>
                  <label htmlFor="email" className="block text-[11px] font-semibold tracking-[0.18em] uppercase text-[var(--text-base)]/70 mb-2">
                    Email
                  </label>
                  <input
                    id="email"
              ...
              <div>
                <label htmlFor="topic" className="block text-[11px] font-semibold tracking-[0.18em] uppercase text-[var(--text-base)]/70 mb-2">
                  What resonates most?
                </label>
              ...
              <div>
                <label htmlFor="message" className="block text-[11px] font-semibold tracking-[0.18em] uppercase text-[var(--text-base)]/70 mb-2">
                  Message
                </label>
                <textarea
                  id="message"
              ...
              <div>
                <label htmlFor="how" className="block text-[11px] font-semibold tracking-[0.18em] uppercase text-[var(--text-base)]/70 mb-2">
                  How did you find me? <span className="text-[var(--text-base)]/50 normal-case tracking-normal">(optional)</span>
                </label>
                <input
                  id="how"
                  name="how"
          ...
          >
            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                ...
                <p className="flex flex-col">
                  <span className="text-[10px] uppercase tracking-wider text-[var(--text-base)]/50 mb-0.5">Response Time</span>
            ...
            <div className="text-sm text-[var(--text-base)]/75 space-y-3">
              <p className="font-semibold text-[var(--text-base)]/90">
                Ready to dive in?
              </p>
